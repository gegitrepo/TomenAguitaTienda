...
public data class DetallePedidoVendedorFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DetallePedidoVendedorFragmentArgs {
      bundle.setClassLoader(DetallePedidoVendedorFragmentArgs::class.java.classLoader)
      val __pedidoId : Long
      ...
      return DetallePedidoVendedorFragmentArgs(__pedidoId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        DetallePedidoVendedorFragmentArgs {
      val __pedidoId : Long?
